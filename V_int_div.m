function [q_plus,q_minus,v_int_plus,v_int_minus] = V_int_div(compare_frac,w_int_plus,w_int_minus,shift_to_int_plus,shift_to_int_minus) %,wr_addr,rd_addr, ite_input_count)
    ...
    v_int_plus = bin2dec(num2str(w_int_plus))+bin2dec(num2str(shift_to_int_plus));
    v_int_minus = bin2dec(num2str(w_int_minus))+bin2dec(num2str(shift_to_int_minus));
    v_upper = v_int_plus - v_int_minus + compare_frac - 1;
