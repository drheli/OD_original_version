...
function [i,q_plus_rev,q_minus_rev,d_plus_rev,d_minus_rev,CAq_plus,CAq_minus,CAd_plus,CAd_minus,CAq_plus_sel, CAq_minus_sel,CAd_plus_sel, CAd_minus_sel, cout_one_plus, cout_one_minus, cout_two_plus, cout_two_minus, shift_o_plus, shift_o_minus,u_r,enable,res_enable,compare_frac,v_int_plus, v_int_minus,v_frac_plus, v_frac_minus,w_int_plus,w_int_minus,w_frac_plus, w_frac_minus,p_plus,p_minus,count] = OD_FPL_ALG(q_in_plus, q_in_minus, d_in_plus, d_in_minus, k,u_r,n_r)
% initialization step
% time_step: j
unrolling = 8;
persistent j;
...
%for j = 1:18
		...
		q_plus_rev = q_in_plus;
        q_minus_rev = q_in_minus;
...
%         end
        ...
        for i = n_r:-1:0
            if i == n_r
			    ...
			    % [6:2] iterative adder 
                !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1
                [shift_to_int_plus,shift_to_int_minus,v_frac_plus,v_frac_minus,compare] = v_frac_div(q_plus,q_minus,w_frac_plus,w_frac_minus,x_plus,x_minus,  i,n_r);
                [q_plus,q_minus,v_int_plus,v_int_minus] = V_int_div(compare_frac,w_int_plus,w_int_minus,shift_to_int_plus,shift_to_int_minus)
                !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!11111
